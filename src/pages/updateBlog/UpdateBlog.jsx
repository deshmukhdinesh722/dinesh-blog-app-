...
import { ProtectedRouteForAdmin } from '../../component/layout/Layout';
import { getDownloadURL, ref, uploadBytes } from 'firebase/storage';
import { analytics, fireDb, storage } from '../../firebase/FirebaseConfig'
...
function UpdateBlog() {
    ...
    const { mode ,updateblogs,getAllBlogs,getAllBlog} = context;
 const params= useParams();
 console.log(params.id);
 const{date,id}=getAllBlog
 console.log(date);
...
uploadImage()
    ...
    return (
        <ProtectedRouteForAdmin><div className=' container mx-auto max-w-5xl py-6'>
            ...
            {/*////////////////////////////////////*/}
                ...
                {/* Four Editor  */}
                <Editor
                    apiKey='yill7upyv1h0dlqvpbkt2el53en31120xyb0n38btgcb6lew'
