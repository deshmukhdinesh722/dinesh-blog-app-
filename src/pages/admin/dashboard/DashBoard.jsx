...
function Dashboard() {
 ...
 useEffect(() => {
    ...
    return (
       <ProtectedRouteForAdmin>  <div className="py-10">
                <div
                    ...
                    <div className="right">
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">deshmukhdinesh722@gmail.com
                        </h2>
                             ...
                             <>{getAllBlog.map((item,index)=>{
                                ...
                                <tr className=" border-b-2" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }}>
                                    ...
                                    <button 
                                        ...
                                        className=' px-4 py-1 rounded-lg text-white font-bold bg-brown-800'>
                                            Edit
                                        </button>
